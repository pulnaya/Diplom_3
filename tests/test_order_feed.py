...
class TestOrderFeed:
    ...
    def test_order_details_modal_appears(self, order_feed_page):
        order_feed_page.go_to_url(FEED_URL)
    ...
    def test_feed_page_user_order_from_history_is_displayed_in_feed(self, created_order, main_page, profile_page, order_feed_page):
    ...
    def test_all_time_orders_counter_increases(self, order_feed_page, authorized_main_page, main_page):
        order_feed_page.go_to_url(FEED_URL) 
    ...
    def test_today_orders_counter_increases(self, order_feed_page, main_page, authorized_main_page):
        order_feed_page.go_to_url(FEED_URL)
    ...
    def test_order_number_appears_in_progress(self, order_feed_page, main_page, authorized_main_page):
        main_page.click_constructor()
